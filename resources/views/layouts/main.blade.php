    ...
    <header class="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="{{ route('pengusaha.index') }}" class="{{ request()->routeIs('pengusaha.*') ? 'text-hipmiBlue border-b-2 border-hipmiBlue' : 'text-gray-600 hover:text-hipmiBlue border-b-2 border-transparent hover:border-gray-300' }} py-8 text-sm font-semibold transition-colors">PENGUSAHA</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-gray-50 border-t border-gray-200 absolute w-full left-0 shadow-lg">
            ...
            <nav class="flex flex-col px-4 pt-2 pb-6 space-y-1">
                ...
                <a href="{{ route('pengusaha.index') }}" class="{{ request()->routeIs('pengusaha.*') ? 'bg-white text-hipmiBlue font-bold' : 'text-gray-600 hover:bg-gray-100 hover:text-hipmiBlue' }} block px-3 py-3 rounded-md text-base font-medium">PENGUSAHA</a>
        ...
        <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="pt-6 md:pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-[0.65rem] md:text-xs text-gray-500 uppercase tracking-widest text-center md:text-left">
                    ...
                    <span class="mt-1 block normal-case font-medium text-gray-400">Built by <a href="https://anoadev.id" target="_blank" class="text-hipmiBlue hover:text-blue-900 transition-colors">anoadev</a></span>
                </p>
