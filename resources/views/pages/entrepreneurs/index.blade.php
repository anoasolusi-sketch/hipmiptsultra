        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl overflow-hidden shadow-sm border {{ $entrepreneur->is_starred ? 'border-yellow-300 ring-2 ring-yellow-100' : 'border-gray-200' }} hover:shadow-md transition relative flex flex-col self-start">
                ...
                <div class="p-6 flex flex-col">
                    ...
                    <div class="border-t border-gray-100 pt-4 mt-4 grid {{ $entrepreneur->website_link ? 'grid-cols-2 gap-2' : 'grid-cols-1' }}">
                        <a href="https://wa.me/{{ preg_replace('/^0/', '62', preg_replace('/[^0-9]/', '', $entrepreneur->phone)) }}" target="_blank" class="flex items-center justify-center text-green-600 hover:text-green-700 font-semibold transition-colors text-sm py-2">
                        ...
                        @if($entrepreneur->website_link)
                        <a href="{{ $entrepreneur->website_link }}" target="_blank" class="flex items-center justify-center text-blue-600 hover:text-blue-700 font-semibold transition-colors text-sm py-2 border-l border-gray-100">
                            <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"></path></svg>
                            Kunjungi Website
                        </a>
                        @endif
                    </div>
