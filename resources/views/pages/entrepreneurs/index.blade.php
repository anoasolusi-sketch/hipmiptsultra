...
<div class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl overflow-hidden shadow-sm border {{ $entrepreneur->is_starred ? 'border-yellow-300 ring-2 ring-yellow-100' : 'border-gray-200' }} hover:shadow-md transition relative flex flex-col h-full">
